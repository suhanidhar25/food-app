...
function Home() {
  return (
    <div className="home-page justify-content-evenly">
            ...
            <Row className="justify-content-center text-center">
              <Col xs={12} md={10} lg={8}>
                ...
                <p className="lead para fst-italic text-start">
                  Welcome to <strong>SLICE & SPOON</strong>, your local haven
                  for delicious Italian flavors. We're proud to offer a
                  mouthwatering selection of handcrafted pizzas, satisfying
                  pasta dishes made with quality ingredients, and tempting
                  desserts to complete your meal. Come experience the taste of
                  Italy with us!
                </p>
              </Col>
            </Row>
      ...
      {/*carousel*/}
      <div className="carousel1 d-flex text-light">
        ...
        <p className="text-centre">
          <strong>
            ...
            modi unde sunt eveniet nemo reiciendis libero. Aliquam molestias
            quia quod quaerat assumenda? Aspernatur tempore corrupti rerum
            reiciendis earum tempora unde?
          </strong>
        </p>
      </div>
      </div>
        ...
        <div className="bestseller-img row align-items-center">
          ...
          <div className="col-md-6">
            <p className="bestseller-para text-white">
              ...
              cumque voluptas quod eligendi sit! Ipsum praesentium, expedita,
              modi adipisci ducimus quod dolores libero ratione incidunt sint
              saepe facere natus amet!
            </p>
          </div>
        </div>
      </div>
